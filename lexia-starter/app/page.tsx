  ...
  return <main className="public-site premium-home">
    ...
    <header className="public-header">
      <div className="public-container public-nav">
        ...
        <nav className="public-links"><Link href="#fonctionnement">Fonctionnement</Link><Link href="/orientation-juridique">Orientation express</Link><Link href="#services">Services</Link><Link href="/impayes">Impayés</Link><Link href="/conseils-juridiques">Guides</Link><Link href="#tarifs">Tarifs</Link></nav>
      ...
      <nav className="mobile-service-menu" aria-label="Menu principal mobile"><div className="mobile-service-menu-inner"><Link href="/" className="active"><span>⌂</span>Accueil</Link><Link href="/orientation-juridique"><span>↗</span>Orientation</Link><Link href="#services"><span>✦</span>Services</Link><Link href="/impayes"><span>€</span>Impayés</Link><Link href="/conseils-juridiques"><span>§</span>Guides</Link><Link href="#domaines"><span>◇</span>Domaines</Link><Link href="#tarifs"><span>◫</span>Tarifs</Link><Link href="#faq"><span>?</span>FAQ</Link><Link href="/connexion"><span>♙</span>Connexion</Link></div></nav>
    </header>
    ...
    <section className="public-hero">
      ...
      <div className="public-container hero-layout">
        <div className="hero-copy">
          ...
          <div className="hero-buttons"><Link className="public-button public-button-gold" href="/inscription">Déposer ma demande</Link><Link className="public-button public-button-light" href="/orientation-juridique">Je ne sais pas par où commencer</Link><Link className="public-button public-button-light" href="/impayes">Recouvrer un impayé</Link></div>
    ...
    <section className="public-section domains-section" id="domaines"><div className="public-container domains-layout"><div className="section-heading left"><span>DOMAINES D’INTERVENTION</span><h2>Une porte d’entrée pour vos principaux litiges.</h2><p>Particulier ou professionnel, choisissez le domaine qui correspond le mieux à votre situation.</p><Link href="/orientation-juridique" className="text-link">Trouver mon parcours en 1 minute →</Link><br/><Link href="/conseils-juridiques" className="text-link">Consulter les guides →</Link></div><div className="domain-grid">{domains.map(([icon,title,description])=><article key={title}><div>{icon}</div><h3>{title}</h3><p>{description}</p><span>En savoir plus →</span></article>)}</div></div></section>
